...
def make_month_csv():
    ...
    with open(filename, "w", newline="", encoding="utf-8") as f:
        ...
        writer.writerow([
            "日付",
            "A班","A-vacation","A-early-notAllow","A-over-notAllow","A人数",
            "B班","B-vacation","B-early-notAllow","B-over-notAllow","B人数",
            "C班","C-vacation","C-early-notAllow","C-over-notAllow","C人数",
            "D班","D-vacation","D-early-notAllow","D-over-notAllow","D人数"
        ])
